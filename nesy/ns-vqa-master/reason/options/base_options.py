...
class BaseOptions():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--clevr_complete_train_scene_path', default='../data/raw/CLEVR_v1.0/scenes/complete_train_scenes.json',
                                 type=str, help='path to complete clevr train scenes')
        self.parser.add_argument('--clevr_complete_val_scene_path', default='../data/raw/CLEVR_v1.0/scenes/complete_val_scenes.json',
                                 type=str, help='path to complete clevr val scenes')
        
        self.parser.add_argument('--clevr_constraint_scene_path', default='../data/raw/CLEVR_v1.0/scenes/constraints.json',
                                 type=str, help='path to constraints scenes')
        ...
        self.parser.add_argument('--clevr_train_question_path', default='../data/reason/clevr_h5_3000/clevr_train_questions.h5',
                                 type=str, help='path to clevr train questions')
        self.parser.add_argument('--clevr_val_question_path', default='../data/reason/clevr_h5_3000/clevr_val_questions.h5',
                                 type=str, help='path to clevr val questions')
        self.parser.add_argument('--clevr_vocab_path', default='../data/reason/clevr_h5_3000/clevr_vocab.json',
