...
class TrainOptions(BaseOptions):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--variable_lengths', default=0, type=int, help='variable input length')
        ...
        self.parser.add_argument('--batch_size', default=1500, type=int, help='batch size')
