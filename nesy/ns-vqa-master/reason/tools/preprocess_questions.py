...
def main(args):
    ...
    for orig_idx, q in enumerate(questions):
        ...
        constraint_type.append(q['constraint_type'])
        complete_image_index.append(q['complete_image_index'])
        #if q['constraint_type'] ==4 and q['complete_image_index']==0:
        #    print('Constraint-type-4')
        #    print("Complete image index:0")
        #    print(question)
        #if q['constraint_type'] ==2 and q['complete_image_index']==21:
        #    print('Constraint-type-2')
        #    print("Complete image index:21")
        #    print(question)
    ...
    #print("image_idxs:", image_idxs)
    #print("complete image_idxs:", complete_image_index)
    ...
    with h5py.File(args.output_h5_file, 'w') as f:
        ...
        f.create_dataset('complete_image_index', data=np.asarray(complete_image_index))
